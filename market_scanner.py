...
TARGET_LIST = [
    ...
    "2609.TW:陽明", "2615.TW:萬海", "1590.TW:亚德客-KY", "2301.TW:光寶科", "2324.TW:仁寶",
...
def send_tg_summary(msg):
    if not TG_TOKEN or not TG_CHAT_ID: 
        print("❌ 錯誤：找不到 Telegram Token 或 Chat ID，無法發送訊息。")
        return
